...
if !FileExist("C:\PrimoConfigs\windowscheck.ini") {
	Gui, -AlwaysOnTop
	msgbox, VOCE DEVE ABRIR O PRIMO PELO LAUNCHER!!!!!
	ExitApp
} else {
...
FileDelete, 															Data.ini
UrlDownloadToFile, 					%URLData%data, 	Data.ini
...
EndConfigAtaque1 = C:\PrimoConfigs\ConfigAtaque%Nick_Tibia%
;==================================================================================
...
;===============================================================================================
	...
	;================================= Auto Target ;=================================
	Gui, Add, text, 		x240	y33		w60					, Hotkey Next Target
	Gui, Add, Hotkey, 		x310	y33		w60					vHotkey_Target, %Hotkey_Target%
	Gui, Add, CheckBox, 	x310	y53 		 		h20 	vTarget, Auto Target
	Gui, Add, DropDownList, x310	y73		w85					vTipoTarget, Next Target||First Target
...
;===============================================================================================
	...
	Gui, add, text,			x20		y78							,Hotkeys
	Gui, Add, Hotkey, 		x20		y104	w60					vHotkeyTrain1, %HotkeyTrain1%
	Gui, Add, Text,			x105	y108						,Training Hotkey 1
	Gui, Add, Hotkey, 		x20		y124	w60					vHotkeyTrain2, %HotkeyTrain2%
	Gui, Add, Text,			x105	y128						,Training Hotkey 2
	Gui, Add, Hotkey, 		x20		y144	w60					vHotkeyTrain3, %HotkeyTrain3%
	Gui, Add, Text,			x105	y148						,Training Hotkey 3
	Gui, Add, Hotkey, 		x20		y164	w60					vHotkeyTrain4, %HotkeyTrain4%
	Gui, Add, Text,			x105	y168						,Training Hotkey 4
	Gui, Add, Hotkey, 		x20		y184	w60					vHotkeyTrain5, %HotkeyTrain5%
	Gui, Add, Text,			x105	y188						,Training Hotkey 5
	Gui, Add, Edit, 		x20		y204	w60	cFF0000			vTimeDelay, %TimeDelay%
	Gui, Add, Text,			x105	y208						,Training Delay (ms)
	;================================= [Push} ;=================================
	Gui, Add, CheckBox, 	x10		y240 				 		vPush, Função Push
	Gui, Add, Hotkey, 		x110	y240	w60					vHotkey_Push, %Hotkey_Push%
	Gui, Add, Button,		x190	y240	w80					gGetPosPush, Get Pos
	Gui, Add, Text,			x295	y220						,X
	Gui, Add, Text,			x335	y220						,Y
	Gui, Add, edit,			x280	y240	w40 h20	ReadOnly	hwndPos1PushX, Pos1PushX 
	Gui, Add, edit,			x325	y240	w40 h20	ReadOnly	hwndPos1PushY, Pos1PushY 
	;Gui, Add, Button,		x190	y270	w80					gGetPosPush2, Pos Destino
	Gui, Add, edit,			x280	y270	w40 h20	ReadOnly	hwndPos2PushX, Pos1PushX 
	Gui, Add, edit,			x325	y270	w40 h20	ReadOnly	hwndPos2PushY, Pos1PushY 
	Gui, Add, Button,		x370	y240						gClearPosPush, Clear
	;================================= [Exercise] ;=================================
	Gui, Add, CheckBox, 	x10		y310 				 		vTreinar, Exercise Training 
	Gui, Add, Hotkey, 		x20		y330		w60				vHotkey_Exercise, %Hotkey_Exercise%
	Gui, Add, Text,			x105	y333						,Hotkey Exercise Weapon
	Gui, add, Edit, 		x20		y350		w60	cFF0000		vExerciseDelay, %ExerciseDelay%
	Gui, Add, Text,			x105	y353						,Delay (ms)
	Gui, Add, Button,		x20		y385						gExercisePos, Get Pos Dummy
...
if (((Target = 1) or (AtkRune1 = 1) or (AtkRune2 = 1) or (AtkRotacao1 = 1) or (AtkRotacao2 = 1)) and (ForaPZ = 1)) {
...
Label7:
if (((Target = 0) and (AtkRune1 = 0) and (AtkRune2 = 0) and (AtkRotacao1 = 0) and (AtkRotacao2 = 0)) or (ForaPZ = 0) or (State_Pause = 1)) {
		Hotkey, ~<%Hotkey_ATK%, Ativa_Ataque, Off
		Ativa_Atk = 0
...
if (WinActive("ahk_class Qt5QWindowOwnDCIcon")) {
	if ((Treinar = 1) and (GetPosDummyX != 0)){
