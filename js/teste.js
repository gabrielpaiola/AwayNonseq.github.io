(function(){
    var load_float_dc = function($){
        var defaults = {
                container_width:300,
                height:500,
                show_facepile:'true',
                tabs:'timeline',
                href:'https://discord.gg/SGgwjUarPu?utm_source=Discord+Widget&amp%3Butm_medium=Connect'
            },
            cfg = $("#float_dc").data(),
            iframe = 'https://discordapp.com/widget?id=843599777101774848&theme=dark',
            params = [],
            png = $("#float_dc").attr('src').replace(/\?.*/, '').replace(/[\w\.]+$/, "Imagens/discord2.png")
        ;
        var val;
        ...
        $("body").append(
            ['<div id="float_dc_plugin" style="visibility:hidden">',
